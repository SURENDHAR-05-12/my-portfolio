        ...
        >
          ...
          <div className="md:w-2/3 w-full">
            ...
            <p className="text-gray-300 leading-relaxed mb-5">
              I’m <span className="text-cyan-400 font-semibold">Surendhar Arasappan</span>, a passionate Junior Software Developer from Tamil Nadu.
              I love crafting responsive, elegant, and user-friendly applications using modern
              mobile technology like <span className="text-purple-400 font-medium">Flutter</span> &{" "}
            ...
            <div className="grid sm:grid-cols-2 gap-y-3 gap-x-6 mb-8 text-sm text-gray-300">
              ...
              <div><strong className="text-cyan-400">Email:</strong> surendhar4943@gmail.com</div>
