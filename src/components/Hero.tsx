  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
        ...
        >
          <Link to="contact" smooth duration={1000} offset={-20}>
          ...
          <a
            href={`${import.meta.env.BASE_URL}SURENDHAR ARASAPPAN-1.pdf`}
            target="_blank"
        ...
        >
           ...
           <a href="mailto:surendhar4943@gmail.com" className="hover:text-purple-400 transition-colors"><Mail className="w-6 h-6" /></a>
        </motion.div>
